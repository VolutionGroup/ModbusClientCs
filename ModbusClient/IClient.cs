...
namespace VVG.Modbus
{
    public interface IClient
    {
        ...
        /// <param name="coilNo">Coil register number (0..9999)</param>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="coilStartNo">First coil register number to read (0..9999)</param>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="inputNo">Input register number (0..9999)</param>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="inputStartNo">First input register number to read (0..9999)</param>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="regNo">Holding register number (0..9999)</param>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="regStartNo">First holding register number to read (0..9999)</param>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="regNo">Input register number (0..9999)</param>
        /// <returns>Input register value read</returns>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="regStartNo">First input register number to read (0..9999)</param>
        /// <param name="len">Number of input registers to read</param>
        /// <returns>Input register values read</returns>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="coilStartNo">First coil register number to write to (0..9999)</param>
        ...
        /// </summary>
        /// <param name="addr">Address of the modbus slave</param>
        /// <param name="regStartNo">First holding register number to write to (0..9999)</param>
